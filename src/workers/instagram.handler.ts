...
export async function publish_to_instagram(data: PublishJobData): Promise<void> {
  console.log(`[SCAFFOLDED] Instagram publish:`, data.content.slice(0, 100));
  ...
  await prisma.platform_posts.update({
    ...
    data: {
      ...
      external_id: `instagram_scaffolded_${Date.now()}`,
    },
  });
